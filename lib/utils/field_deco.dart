...
InputDecoration fieldDecoNew({
  ...
  return InputDecoration(
    filled: isFilled,
    fillColor: value ? AllColors.white : fillColor,
...
OutlineInputBorder fieldEnabledFillBorder(
    ...
    OutlineInputBorder(
        ...
        borderSide: BorderSide(color: value ? AllColors.white : Colors.black87));
...
OutlineInputBorder fieldEnabledLineBorder(
    ...
    OutlineInputBorder(
      borderSide:
      BorderSide(color: value ? AllColors.white : Colors.black54, width: 1.2),
...
OutlineInputBorder fieldDisabledBorder(
    ...
    OutlineInputBorder(
      borderSide: BorderSide(
          color: value ? AllColors.white : Colors.grey.withOpacity(0.5),
          width: 1.2),
      borderRadius: classBorderRadius ?? BorderRadius.circular(30.0),
    );
...
OutlineInputBorder focusedFillBorder(
    ...
    OutlineInputBorder(
        borderRadius: classBorderRadius ?? BorderRadius.circular(30.0),
        borderSide: BorderSide(
            color: value ? AllColors.white : Colors.black.withOpacity(0.8),
            width: 2));
...
OutlineInputBorder focusedLineBorder(
    ...
    OutlineInputBorder(
      borderSide:
      BorderSide(color: value ? AllColors.white : Colors.black, width: 1.5),
      borderRadius: classBorderRadius ?? BorderRadius.circular(30.0),
    );
