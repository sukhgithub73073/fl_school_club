...
InputDecoration fieldDeco({
  ...
  return InputDecoration(
    enabledBorder: UnderlineInputBorder(
        borderSide: BorderSide(color: borderSideColor ?? AllColors.primary)),
    ...
    suffixIconColor: AllColors.primary,
    labelText: labelText,
    hintText: hintText,
  );
}
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(
                ...
                onSurface: AllColors.black // body text color
                ),
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                foregroundColor: AllColors.primary, // button text color
              ),
            ),
          ),
          child: child!,
